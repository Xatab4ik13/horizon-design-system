...
const BlogPage = () => {
  ...
  return (
    ...
    >
      <SEO pageKey="blog"
        title="Блог о мебели из массива и изделиях из дерева"
        description="Статьи мастерской FAKTURA: породы дерева, покрытия маслом-воском, уход за мебелью из массива, выбор деревянного декора и тренды интерьера."
        type="website"
