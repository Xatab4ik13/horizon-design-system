...
const GalleryPage = () => {
  ...
  return (
    ...
    >
      <SEO pageKey="gallery"
        title="Галерея работ из дерева"
        description="Реальные проекты мастерской FAKTURA: мебель из массива, деревянные панно и зеркала в интерьерах. Вдохновляйтесь и заказывайте похожее."
      />
      <Header />
